...
class SegundoTest {
    ...
    public void testCenarioMaior() throws Exception {
        ...
        // Verificar status dos candidatos aprovados, qualificados e recebidos usando os IDs armazenados
        for (int id : ids) {
            if (id % 6 == 0) {
        ...
        // Verificar status dos candidatos desqualificados, aprovados, qualificados e recebidos usando os IDs armazenados
        for (int id : ids) {
            if (id % 4 == 0) {
